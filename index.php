...
require_once './php/config/db_function.php';
...
<html lang="en">
  ...
  <head>
    ...
    <title>LIRS - E-Commerce Website</title>
              ...
              <?php foreach ($products as $product) {?>
                <a href="single-product.php?id=<?php echo $product['product_id']?>">
                  <div class="featured-item">
                    <img height="300" src="<?php echo './supplier/images/' . $product['product_image']?>" alt="Item 1">
                    <h4><?php echo $product['product_name'] ;?></h4>
                    <h6><?php echo asNaira($product['product_price']); ?></h6>
                  </div>
                </a>
              <?php }?> 
            </div>
